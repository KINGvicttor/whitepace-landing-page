    ...
    return (
        <section className="w-full h-[812px] bg-white text-black">
            <div className="container mx-auto h-full flex items-center justify-between">
                <img className="w-[602px] h-[448px] absolute mt-[500px] ml-[935px] border border-red-500" src={containerBg.src} />
                <div className="w-[714px] h-[532px] bg-secondary-blue rounded-lg">

                </div>
                <div className="w-[669px] h-[411px] flex flex-col justify-center border border-amber-500">
