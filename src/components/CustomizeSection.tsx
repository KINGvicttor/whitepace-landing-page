            ...
            <div className="container mx-auto h-full flex items-center justify-between">
                ...
                <div className="w-[669px] h-[411px] flex flex-col justify-center">
                    ...
                    <div className="w-[669px] h-[90px]">
                        <p className="text-lg">Customise the app with plugins, custom themes and multiple text editors (Rich Text or Markdown). Or create your own scripts and plugins using the Extension API.</p>
                    </div>
